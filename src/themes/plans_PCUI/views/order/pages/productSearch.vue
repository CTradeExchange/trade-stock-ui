        ...
        >
            <template v-if='searching' #default>
                <slot :list='searchList' name='list'>
                    <ProductListStock v-if="tradeType==='6'" :list='searchList' />
                    <ProductList v-else :list='searchList' />
                </slot>
            </template>
            <!-- 搜索结果 -->
            <template v-else #default>
                ...
                <slot :list='productList' name='list'>
                    <ProductListStock v-if="tradeType==='6'" :category-type='categoryType' :list='productList' />
