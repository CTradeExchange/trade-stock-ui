<template>
    <div class='page-wrap'>
        ...
        <van-tabs v-model:active='active' class='tabs'>
            <van-tab v-if='Number(tradeType) === 6' :title="$t('trade.trustList')">
                <stockPendingList />
            </van-tab>

            <van-tab v-else name='pending' :title="$t('trade.curTrust')">
...
import stockPendingList from './components/stockPendingList.vue'
export default {
    components: {
        trustItem,
        orderList,
