...
import dealItemStock from '@plans/modules/deal/dealItemStock.vue'
import sidebarProduct from '@plans/components/sidebarProduct.vue'
import { queryStockDealPage, tradeRecordList, queryStockPosition } from '@/api/trade'
