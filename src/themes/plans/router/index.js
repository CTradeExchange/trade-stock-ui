...
const routes = [
    ...
    },
    {
        ...
        name: 'PositionDetailStock',
        component: () => import(/* webpackChunkName: "otherpage" */ '../views/position/positionDetailStock.vue'),
        meta: {
            title: 'route.positionDetail'
        }
    },
    ...
    },
    {
        ...
        path: '/stock',
        name: 'Stock',
        component: () => import(/* webpackChunkName: "fundProduct" */ '../views/stock/index.vue'),
        meta: {
            title: '股票'
        }
    ...
    },
    {
        path: '/corporateAct',
        name: 'CorporateAct',
        component: () => import(/* webpackChunkName: "corporateAct" */ '../views/chart/corporateAct.vue'),
        meta: {
    ...
    },
    {
        path: '/randomKey',
        name: 'RandomKey',
        component: () => import(/* webpackChunkName: "randomKey" */ '../views/randomKey/randomKey.vue'),
        meta: {
            title: '',
        }
    },
